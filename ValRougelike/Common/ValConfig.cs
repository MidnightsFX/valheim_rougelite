...
public class ValConfig
{
    ...
    private void CreateConfigValues(ConfigFile Config)
    {
        ...
        MaximumPercentEquipmentRetainedOnDeath = BindServerConfig("DeathProgression", "MaximumPercentEquipmentRetainedOnDeath", 90f, "The maximum amount of Equipment that can be retained on death, depends on players individual skill.", true, 0f, 100f);
